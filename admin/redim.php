...
$source = imagecreatefromjpeg("../img/".$_GET['image']); // La photo est la source
...
{
    header("LOCATION:dashboard.php?update=success&id=".$_GET['update']);
}else{

    header("LOCATION:addGame.php?add=success");
}